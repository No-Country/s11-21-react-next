  ...
  return (
    <footer className='relative h-auto w-full  bg-[#FD7B03] p-7'>
        ...
        <div className="my-4">
          ...
          <p className='text-[#fff] flex items-cente text-sm'><AiOutlineQuestionCircle className=" text-2xl mr-2"></AiOutlineQuestionCircle>Consulta nuestras preguntas frecuentes</p>
        </div>
        <div className="mb-4">
