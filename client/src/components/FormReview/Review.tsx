...
export default function Review() {
  ...
  return (
    <div className="w-11/12 xl:w-3/5 h-auto px-6 text-[#000]  justify-center">
      <div className="w-full px-2 border-t-2 border-[#FFCF91] py-8">
        ...
        <div className="flex justify-center items-center">
          <button className="bg-[#FD7B03] w-full lg:w-2/4   h-12 mt-2 rounded-lg text-[#fff] font-semibold">
            Enviar opinión
          </button>
        </div>
      </div>
