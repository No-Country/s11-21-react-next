...
export default function Formulario() {
  return (
    <div className="w-screen top-[1258px] left-[-1px] bg-[#FFF4E0] p-[10%] lg:p-8 flex flex-col items-center">
      ...
      <Link
        href={"/form"}
        className="bg-[#FD7B03] w-full text-center text-sm font-medium text-white my-2 md:w-[287px] h-[40px] md:h-[40px] p-2 md:p-[9px 97px 9px 97px] rounded-[5px] hover:opacity-90"
      >
        Llenar formulario
      </Link>
    </div>
