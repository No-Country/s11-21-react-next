...
import CardImage1 from '../../../public/foto_jardin-japones-BsAs.jpg';
import CardImage2 from '../../../public/foto_iglesia-Los-Capuchinos.jpg';
...
import SelectImageClick from './SelectImageClick';
...
const TouristPlaceCard = ({ showImage }: TouristPlaceCardProps) => {
    const renderImage = () => {
        if (showImage === 1) {
          return (
            <Image
              ...
              alt="Card image 1"
              priority
              className="w-[348px] h-[216px] rounded-lg"
  ...
  return (
    <div className="grid my-5">
        ...
        <div className="w-[348px] justify-self-center text-[14px] flex justify-between mb-5">
            <div className="w-[315px] text-left flex flex-col gap-2">
                ...
                <Link href="https://www.google.com/maps/place/Jard%C3%ADn+Japon%C3%A9s+de+Escobar,+B1625+Bel%C3%A9n+de+Escobar,+Provincia+de+Buenos+Aires/@-34.3524909,-58.79789,16z/data=!4m6!3m5!1s0x95bb61b90c949f8d:0x957ce105f51ea2dd!8m2!3d-34.3524909!4d-58.79789!16s%2Fg%2F1hc8ms9lw">
                    <p className='text-blue-500 hover:font-semibold'>Buenos Aires. Argentina</p>
                </Link>
                </div>
            ...
            <div className="flex flex-col">
                <div className="w-[14.5px] h-[21px] grid items-center justify-end">
                    <Image src={HeartImage} alt="Heart image" className='w-auto h-auto' width={14.5} />
                </div>
            </div>
        </div>


        <div className="w-[348px] h-[216px] justify-self-center relative grid">

          {renderImage()}

          <div className='absolute bg-[#FD7B03] rounded-lg bottom-3 left-3 z-10 flex items-center gap-1 px-2 py-1'>
...
const TouristPlaceCard = () => {
  ...
  return (
    <div className="grid my-3">
        ...
        <div className="w-[348px] justify-self-center text-[14px] flex justify-between mb-3">
            <div className="w-[315px] text-left flex flex-col gap-2">
                <div className="relative">
                <p>
                    Jardín Japonés 
            ...
            <div className="flex flex-col">
                <div className="w-[15px] h-[21px] grid items-center justify-end">
