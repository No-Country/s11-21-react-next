...
export default function page() {
  ...
  return (
    <main className="bg-[url('/fondoLogin.png')] bg-contain w-full h-screen xl:bg-auto">
      ...
      <div className="bg-white absolute px-8 py-4 top-40 w-full h-auto rounded-t-[40px] xl:w-[calc(100%-640px)] xl:right-0 xl:top-0 xl:rounded-none max-md:top-0 max-md:rounded-none">
        <Image src="/LogoLarge.png" className='mx-auto m max-md:mt-8' alt='image-register' width={100} height={100}/>
